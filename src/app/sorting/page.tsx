...
export default function SortingPage() {
  ...
  return (
    <main
      ref={containerRef}
      className="min-h-screen bg-white dark:bg-zinc-950 pt-24 pb-24"
    >
      <div className="container mx-auto px-6">
        ...
        <header className="mb-20 max-w-3xl pt-16">
          ...
          <h1 className="reveal text-4xl font-bold tracking-tight text-zinc-900 dark:text-white mb-6">
            排序算法可视化
          </h1>
          <p className="reveal text-base text-zinc-500 dark:text-zinc-400 font-medium leading-relaxed">
