  ...
  return (
    ...
    >
      <div className="gsap-reveal relative">
        <div
          ref={logoRef}
          className="bg-primary shadow-primary/20 flex h-24 w-24 items-center justify-center rounded-[2rem] shadow-2xl"
        >
          <span className="text-primary-foreground text-5xl font-black">{logoLetter}</span>
        </div>

        <div className="absolute -right-2 -bottom-2">
          <div className="bg-background ring-border/10 rounded-full p-1.5 shadow-xl ring-1">
      ...
      <div className="space-y-2 text-center">
        <h1 className="gsap-reveal text-foreground mb-1 text-2xl font-black tracking-tighter uppercase">
          {siteName}
        </h1>
