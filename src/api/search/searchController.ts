...
export async function doSearchAll(body: SearchAPI.SearchRequest,
...
export async function batchUpsertPost(body: SearchAPI.PostEsDTO[],
                                      options ?: { [key: string]: any }
) {
...
export async function searchPostByPage(body: SearchAPI.PostQueryRequest,
                                       options ?: { [key: string]: any }
) {
...
export async function batchUpsertUser(body: SearchAPI.UserEsDTO[],
                                      options ?: { [key: string]: any }
) {
...
export async function searchUserByPage(body: SearchAPI.UserQueryRequest,
                                       options ?: { [key: string]: any }
) {
