...
export async function askStream(body: AiAPI.RAGAskRequest, options?: { [key: string]: any }) {
...
export async function listRagHistoryVoByPage(
  body: AiAPI.RAGHistoryQueryRequest,
...
export async function analyzeRecall(
  body: AiAPI.RecallAnalysisRequest,
  options?: { [key: string]: any }
) {
