...
export async function addPostComment(body: PostAPI.PostCommentAddRequest,
...
export async function deletePostComment(body: PostAPI.DeleteRequest,
                                        options ?: { [key: string]: any }
) {
...
export async function editPostComment(body: PostAPI.PostCommentEditRequest,
                                      options ?: { [key: string]: any }
) {
...
export async function listPostCommentByPage(body: PostAPI.PostCommentQueryRequest,
                                            options ?: { [key: string]: any }
) {
...
export async function listPostCommentVoByPage(body: PostAPI.PostCommentQueryRequest,
                                              options ?: { [key: string]: any }
) {
...
export async function listMyPostCommentVoByPage(body: PostAPI.PostCommentQueryRequest,
                                                options ?: { [key: string]: any }
) {
...
export async function updatePostComment(body: PostAPI.PostCommentUpdateRequest,
                                        options ?: { [key: string]: any }
) {
