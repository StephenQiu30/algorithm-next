...
export async function addPost(body: PostAPI.PostAddRequest,
...
export async function deletePost(body: PostAPI.DeleteRequest,
                                 options ?: { [key: string]: any }
) {
...
export async function editPost(body: PostAPI.PostEditRequest,
                               options ?: { [key: string]: any }
) {
...
export async function listPostByPage(body: PostAPI.PostQueryRequest,
                                     options ?: { [key: string]: any }
) {
...
export async function listPostVoByPage(body: PostAPI.PostQueryRequest,
                                       options ?: { [key: string]: any }
) {
...
export async function listMyPostVoByPage(body: PostAPI.PostQueryRequest,
                                         options ?: { [key: string]: any }
) {
...
export async function reviewPost(body: PostAPI.PostReviewRequest,
                                 options ?: { [key: string]: any }
) {
...
export async function updatePost(body: PostAPI.PostUpdateRequest,
                                 options ?: { [key: string]: any }
) {
