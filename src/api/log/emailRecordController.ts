...
export async function addEmailRecord(body: LogAPI.EmailRecordAddRequest,
...
export async function deleteEmailRecord(body: LogAPI.DeleteRequest,
                                        options ?: { [key: string]: any }
) {
...
export async function listRecordByPage1(body: LogAPI.EmailRecordQueryRequest,
                                        options ?: { [key: string]: any }
) {
