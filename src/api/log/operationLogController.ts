...
export async function addOperationLog(body: LogAPI.OperationLogAddRequest,
...
export async function deleteOperationLog(body: LogAPI.DeleteRequest,
                                         options ?: { [key: string]: any }
) {
...
export async function listLogByPage(body: LogAPI.OperationLogQueryRequest,
                                    options ?: { [key: string]: any }
) {
