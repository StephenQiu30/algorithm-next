...
export async function addApiAccessLog(body: LogAPI.ApiAccessLogAddRequest,
...
export async function deleteApiAccessLog(body: LogAPI.DeleteRequest,
                                         options ?: { [key: string]: any }
) {
...
export async function listLogByPage2(body: LogAPI.ApiAccessLogQueryRequest,
                                     options ?: { [key: string]: any }
) {
