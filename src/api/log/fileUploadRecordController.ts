...
export async function addFileUploadRecord(body: LogAPI.FileUploadRecordAddRequest,
...
export async function deleteFileUploadRecord(body: LogAPI.DeleteRequest,
                                             options ?: { [key: string]: any }
) {
...
export async function listRecordByPage(body: LogAPI.FileUploadRecordQueryRequest,
                                       options ?: { [key: string]: any }
) {
