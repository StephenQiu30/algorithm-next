...
export async function addUserLoginLog(body: LogAPI.UserLoginLogAddRequest,
...
export async function deleteUserLoginLog(body: LogAPI.DeleteRequest,
                                         options ?: { [key: string]: any }
) {
...
export async function listLogByPage1(body: LogAPI.UserLoginLogQueryRequest,
                                     options ?: { [key: string]: any }
) {
